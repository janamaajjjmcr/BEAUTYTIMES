...
This project was created for the **CS475 Mobile Application Development** course. The goal is to build a functional Android mobile application that includes multiple activities, database connection, navigation, and a user-friendly interface.  [oai_citation:0‡CS475 Project.docx](sediment://file_00000000c5cc71f492f0b5e94da2a414)
...
5. Register a new account, log in, and start booking salon services.

## Author

Developed as a mobile application course project.
